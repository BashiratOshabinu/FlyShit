...
import { View, Text, StatusBar, SafeAreaView, StyleSheet, ImageBackground, TextInput, TouchableOpacity, ScrollView, KeyboardAvoidingView,Platform } from 'react-native';
          ...
          <View style={styles.container}>
            ...
            >
              {(prop) => {
                return (
                  <View>
                    <Text style={{ fontSize: 40, marginTop: 30, fontWeight: 'bold',  }}>Reset Password</Text>
